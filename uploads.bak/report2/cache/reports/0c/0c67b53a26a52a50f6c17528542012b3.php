...
class __TwigTemplate_7594d0f657080ccae6f3acee3e1ba907 extends Template
{
    private $source;
    private $macros = [];
...
{{- config.text|default('<table cellpadding=\"8\" cellspacing=\"0\" style=\"width: 100%; height: 77px; border: 1px solid #666666; border-color: #666666;\"><tbody><tr><td style=\"width: 33%; vertical-align: top;\"><b style=\"color: red;\">This is an example of</b><br/>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</td><td style=\"width: 33%; vertical-align: top;\"><b style=\"color: blue;\">Rich text and HTML</b><br/>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</td><td style=\"width: 33%; vertical-align: top;\"><b style=\"color: green;\">In a three column layout</b><br/>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</td></tr></tbody></table>')|raw -}}
<br/>
", "reports/misc/textRich.twig.html", "/Applications/MAMP/htdocs/chhs/modules/Reports/templates/reports/misc/textRich.twig.html");
    }
}
