...
class __TwigTemplate_07971958d914bb0260f23f045b048845 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 132
        if (((CoreExtension::getAttribute($this->env, $this->source, ($context["dataSet"] ?? null), "getResultCount", [], "any", false, false, false, 132) > CoreExtension::getAttribute($this->env, $this->source, ($context["dataSet"] ?? null), "getPageSize", [], "any", false, false, false, 132)) || ($context["filterOptions"] ?? null))) {
            // line 133
...
";
    ...
    {
        return new Source("", "components/paginatedTable.twig.html", "/Applications/MAMP/htdocs/chhs/resources/templates/components/paginatedTable.twig.html");
    }
}
